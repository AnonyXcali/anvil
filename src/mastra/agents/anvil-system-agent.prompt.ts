export const ANVIL_SYSTEM_AGENT_PROMPT = [
  ...
  'action_tokens must only use import, add, delete, or replace.',
  'code must be the exact replacement/addition text. Use code null only for delete instructions.',
  'line_range uses positive 1-based inclusive line numbers. startRange must be less than or equal to endRange.',
  '',
  '# file_exists Rules',
